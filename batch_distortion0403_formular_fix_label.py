...
folder="/mnt/hwfile/opendatalab/bigdata_mineru/liuzheng/Mineru/dataset/Final/Formula-400k"
file_dict={
    "mineru2_handwriting_pure-formula_100k.json": 3, # 每隔3取1个
    "mineru2_unimernet_pure-formula_200k.json": 3,
}
...
if __name__ == '__main__':
    ...
    target_meta_data_path = os.path.join(target_folder, f"mineru2_formular_{args.distortion}_{args.chunk_idx:02d}_{args.chunk_num:02d}_fixlabel.json")
