...
parser.add_argument("--chunk_num", type=int, default=16)
...
# folder="/mnt/hwfile/opendatalab/bigdata_mineru"
file_dict={
    "/mnt/hwfile/opendatalab/bigdata_mineru/zhangrui/shared_data/mineru_lvlm_data/mineru_math_cn200K.json": 14,
    "/mnt/hwfile/opendatalab/bigdata_mineru/zhangrui/shared_data/mineru_lvlm_data/mineru_math_en200K.json": 14,
    "/mnt/hwfile/opendatalab/bigdata_mineru/liuzheng/Mineru/dataset/Stage2/Mineru_exam_zh-140k.json": 4,
    "/mnt/hwfile/opendatalab/bigdata_mineru/liuzheng/Mineru/dataset/Stage2/Mineru_cn-2000k.json": 25,
    "/mnt/hwfile/opendatalab/bigdata_mineru/liuzheng/Mineru/dataset/Stage2/Mineru_en-2000k.json": 25,
    "/mnt/hwfile/opendatalab/bigdata_mineru/liuzheng/Mineru/dataset/Stage2/Mineru_table_zh-440k.json": 8,
    "/mnt/hwfile/opendatalab/bigdata_mineru/liuzheng/Mineru/dataset/Stage2/Mineru_table_en-100k.json": 8,
    "/mnt/hwfile/opendatalab/bigdata_mineru/liuzheng/Mineru/dataset/Stage2/Mineru_exam_en-8k.json": 2,
    "/mnt/hwfile/opendatalab/bigdata_mineru/liuzheng/Mineru/dataset/Stage2/Mineru_3col_zh-30k.json": 2,
    "/mnt/hwfile/opendatalab/bigdata_mineru/liuzheng/Mineru/dataset/Stage2/Mineru_3col_en-20k.json": 2,
}
...
if __name__ == '__main__':
    ...
    print(f"len(all_meta_data): {len(all_meta_data)}")
    target_meta_data_path = os.path.join(args.target_folder, f"mineru2_doc_{args.distortion}_{args.chunk_idx:02d}_{args.chunk_num:02d}.json")
