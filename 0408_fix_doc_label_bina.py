...
def replace_conversations(source_data, corrected_datasets):
    ...
    for idx, source_item in tqdm(enumerate(source_data)):
        ...
        source_prefix=f"s3://doc-parse-huawei/mineru2/distortion/{distortion}"
        ...
        try:
            ...
            print(f"Warning: ID {source_id} not found in any corrected dataset.", flush=True)
...
if __name__ == "__main__":
    # 源数据集文件路径
    source_file_path = "/mnt/petrelfs/chenjingzhou/cjz/doc-distortion/0408batch_distorted_images_bigger_distortion/mineru2_doc_binarization_combine_79257.json"
