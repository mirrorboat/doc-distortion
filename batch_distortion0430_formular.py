...
parser.add_argument("--target_folder", type=str, default="0403distortion_formular")
args = parser.parse_args()

folder="/mnt/hwfile/doc_parse/lz/0501_data/Formula_Recognition"
file_dict={
    "mineru2_handwriting_pure-formula_200k.json": 6, # 每隔3取1个
    "mineru2_unimernet_pure-formula_400k.json": 6,
}
...
if __name__ == '__main__':
    s3_prefix="s3://doc-parse-huawei/mineru2/distortion/0430"
    for meta_data_path in file_dict.keys():
        ...
        for idx in tqdm(range(len(my_dataset))):
            try:
                ...
                image_name = image_name.split("/mnt/hwfile/opendatalab/bigdata_mineru/wangbin/mllm/data/math/mfr/UniMath1M/train/")[-1]
                image_name = image_name.split("/mnt/hwfile/opendatalab/bigdata_mineru/zhangqintong/data/HME_Dataset/")[-1]
    ...
    target_meta_data_path = os.path.join(target_folder, f"mineru2_formular_0430_{args.distortion}_{args.chunk_idx:02d}_{args.chunk_num:02d}.json")
