...
def get_phase():
    ...
    paper_phase = [
        WaterMark(
            ...
            watermark_color=(random.randint(150, 255), random.randint(150, 255), random.randint(150, 255)),
...
for i in range(100):
    ink_phase, paper_phase, post_phase = get_phase()
    pipeline = AugraphyPipeline(ink_phase=ink_phase, paper_phase=paper_phase, post_phase=post_phase, ink_color_range=(0, 0),)
